...
def random_forest_training():
    ...
    features=df[['SIFT_score','PPH_score','gerp_score','bind_site','volume_change_index','polarity_change_index',\
                 'distance','distance_normed','allele_freq','germline_somatic',\
    ...
    clf=RandomForestClassifier(random_state=10000,n_estimators=1500,max_features='log2',oob_score=True)
